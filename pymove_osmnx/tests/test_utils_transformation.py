...
from pymove_osmnx.utils import transformation
...
def test_feature_values_using_filter():
    ...
    new_move_df = transformation.feature_values_using_filter(
        move_df,
        1,
        LATITUDE,
        np.array([0, 1]),
    ...
    transformation.feature_values_using_filter(
        move_df,
        1,
        LATITUDE,
        np.array([0, 1]),
...
def test_feature_values_using_filter_and_indexes():
    ...
    new_move_df = transformation.feature_values_using_filter_and_indexes(
        move_df,
        1,
        LATITUDE,
        [0 , 1, 2],
    ...
    transformation.feature_values_using_filter_and_indexes(
        move_df,
        1,
        LATITUDE,
        [0 , 1, 2],
